...
export function Projects() {
  ...
  return (
    <div className="w-full mt-40 flex flex-col justify-center items-center text-white gap-14 border-b-[1px] border-zinc-900">
      ...
      <div className="w-4/5 mb-40 flex flex-col p-3 gap-5">
        {repos.map((repo: any) => (
          <div
            key={repo.name}
            className="w-3/5 even:self-end self-start rounded-lg text-zinc-500 hover:text-white hover:text-xl hover:bg-zinc-900 transition-all duration-700"
          >
