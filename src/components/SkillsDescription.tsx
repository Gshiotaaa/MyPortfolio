...
export function SkillsDescription({
  ...
  return (
    <div className="flex gap-4">
      <div className=" flex flex-col items-center gap-14 hover:bg-zinc-900 hover:gap-0 transition-all duration-700  w-60 h-[340px] rounded-md px-3 py-8 group overflow-hidden">
        ...
        <img
          ...
          title={title}
        />
        <p className=" group-hover:opacity-100 opacity-0 transition-all duration-700 text-center">
          {description}
        </p>
      </div>
    </div>
